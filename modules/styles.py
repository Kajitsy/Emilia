...
class SvgIcons:
    ...
    def model_type_icon(self, model_type, color='#A2A2AC', pixmap_ret=False):
        if model_type == 'MODEL_TYPE_FAST':
            svg = f"""<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19.5657 9H13.5C13.2239 9 13 8.77614 13 8.5V2.40139C13 1.90668 12.3584 1.71242 12.084 2.12404L4.01823 14.2226C3.79672 14.5549 4.03491 15 4.43426 15H10.5C10.7761 15 11 15.2239 11 15.5V21.5986C11 22.0933 11.6416 22.2876 11.916 21.876L19.9818 9.77735C20.2033 9.44507 19.9651 9 19.5657 9Z" stroke="{color}" stroke-width="2" stroke-linejoin="round"></path></svg>"""
        elif model_type == 'MODEL_TYPE_BALANCED':
            svg = f"""<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 6C5 5.44772 5.44772 5 6 5H8C8.55228 5 9 4.55228 9 4C9 3.44772 8.55228 3 8 3H6C4.34315 3 3 4.34315 3 6V8C3 8.55228 3.44772 9 4 9C4.55228 9 5 8.55228 5 8V6Z" fill="{color}"></path><path d="M16 3C15.4477 3 15 3.44772 15 4C15 4.55228 15.4477 5 16 5H18C18.5523 5 19 5.44772 19 6V8C19 8.55228 19.4477 9 20 9C20.5523 9 21 8.55228 21 8V6C21 4.34315 19.6569 3 18 3H16Z" fill="{color}"></path><path d="M5 16C5 15.4477 4.55228 15 4 15C3.44772 15 3 15.4477 3 16V18C3 19.6569 4.34315 21 6 21H8C8.55228 21 9 20.5523 9 20C9 19.4477 8.55228 19 8 19H6C5.44772 19 5 18.5523 5 18V16Z" fill="{color}"></path><path d="M21 16C21 15.4477 20.5523 15 20 15C19.4477 15 19 15.4477 19 16V18C19 18.5523 18.5523 19 18 19H16C15.4477 19 15 19.4477 15 20C15 20.5523 15.4477 21 16 21H18C19.6569 21 21 19.6569 21 18V16Z" fill="{color}"></path><path d="M12.4081 9.06623C12.3598 9.16299 12.2813 9.24145 12.1845 9.28983L10.8947 9.93475C10.5262 10.119 10.5262 10.6449 10.8947 10.8292L12.1845 11.4741C12.2813 11.5225 12.3598 11.6009 12.4081 11.6977L13.0531 12.9875C13.2373 13.3561 13.7632 13.3561 13.9475 12.9875L14.5924 11.6977C14.6408 11.6009 14.7192 11.5225 14.816 11.4741L16.1058 10.8292C16.4744 10.6449 16.4744 10.119 16.1058 9.93475L14.816 9.28983C14.7192 9.24145 14.6408 9.16299 14.5924 9.06623L13.9475 7.77639C13.7632 7.40787 13.2373 7.40787 13.0531 7.77639L12.4081 9.06623Z" fill="{color}"></path><path d="M8.71166 13.4592C8.68263 13.5172 8.63556 13.5643 8.5775 13.5934L7.53693 14.1136C7.31581 14.2242 7.31582 14.5397 7.53693 14.6503L8.5775 15.1706C8.63556 15.1996 8.68263 15.2467 8.71166 15.3047L9.23195 16.3453C9.3425 16.5664 9.65804 16.5664 9.7686 16.3453L10.2889 15.3047C10.3179 15.2467 10.365 15.1996 10.423 15.1706L11.4636 14.6503C11.6847 14.5397 11.6847 14.2242 11.4636 14.1136L10.423 13.5934C10.365 13.5643 10.3179 13.5172 10.2889 13.4592L9.7686 12.4186C9.65804 12.1975 9.3425 12.1975 9.23194 12.4186L8.71166 13.4592Z" fill="{color}"></path></svg>"""
        elif model_type == 'MODEL_TYPE_SMART':
            svg = f"""<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 6.5L17.4448 8.98386C16.6121 8.97828 15.7463 9.08581 14.8767 9.3188C14.0072 9.55178 13.2037 9.89153 12.4854 10.3127L8.23926 9.32674L9.11761 14.1907C8.79389 15.135 8.73348 16.1269 8.99221 17.0925C9.29987 18.2407 10.0169 19.1954 11 19.8962M7 20H17C18.6569 20 20 18.6569 20 17V7C20 5.34315 18.6569 4 17 4H7C5.34315 4 4 5.34315 4 7V17C4 18.6569 5.34315 20 7 20Z" stroke="{color}" stroke-width="2" stroke-linejoin="round"></path><path d="M13.9894 14.4899C14.1727 15.1742 13.8591 15.8527 13.2889 16.0055C12.7187 16.1583 12.1078 15.7275 11.9244 15.0432C11.7411 14.359 12.0547 13.6804 12.6249 13.5276C13.1951 13.3748 13.806 13.8057 13.9894 14.4899Z" fill="{color}"></path><path d="M20.1837 12.83C20.367 13.5143 20.0534 14.1928 19.4832 14.3456C18.913 14.4984 18.3021 14.0676 18.1188 13.3833C17.9354 12.699 18.249 12.0205 18.8192 11.8677C19.3895 11.7149 20.0003 12.1458 20.1837 12.83Z" fill="{color}"></path><path d="M18.068 16.4955C18.1903 16.9516 17.7347 17.4701 17.0504 17.6534C16.3661 17.8367 15.7124 17.6156 15.5901 17.1594C15.4679 16.7032 15.9235 16.1848 16.6078 16.0015C17.292 15.8181 17.9458 16.0393 18.068 16.4955Z" fill="{color}"></path></svg>"""
        elif model_type == 'MODEL_TYPE_FAMILY_FRIENDLY':
            svg = f"""<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.50001 12C10.775 9.65312 10.775 5.8469 9.50001 3.5M9.50001 12C6.83011 12.0698 3.53429 13.972 2.13939 16.25M9.50001 12C10.8949 14.278 14.1911 16.1802 16.861 16.25M5.2535 13.3546C6.86135 15.9798 9.88198 18.3204 13.1039 19.6903M1.04194 11.2001C3.86395 9.13147 7.38385 7.72315 10.4519 7.64352M12.7994 15.0018C14.2685 12.297 14.7884 8.51498 14.3705 5.03892M15.5104 5.9896C18.8299 9.30906 18.8299 14.691 15.5104 18.0104C12.1909 21.3299 6.80903 21.3299 3.4896 18.0104C0.170135 14.6909 0.170135 9.30903 3.4896 5.9896C6.80906 2.67013 12.191 2.67013 15.5104 5.9896Z" stroke="{color}" stroke-width="1.88889" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18.5 14.5C21.5 15 17.5 17.5796 21 18.0796C25.5 19.0796 19.1046 20.5796 18 20.5796H17" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>"""
        else:
            svg = ""
        pixmap = self._svg_to_pixmap(svg)
