...
class WSClient(BaseClient):
    ...
    async def send_message_stream(self, char_id: str, chat_id: str, text: str, author: dict = None,
    ...
    async def regenerate_turn_stream(self, char_id: str, chat_id: str, turn_id: str, user_name: str = ""):
    ...
    async def create_new_chat(self, char_id: str, creator_id: str, preferred_model_type: str = "MODEL_TYPE_BALANCED",
                              scene_id: str = ""):
