...
from PyQt6.QtGui import QIntValidator, QKeySequence, QRegularExpressionValidator
...
from modules.ui.cards import CookieCards, ThemeCards, UserCards
...
class SettingsPage(QWidget):
    def __init__(self, parent=None):
        ...
        self.languages = {
            ...
            "ru_RU": {
                "title": self.tr("Russian"),
                "lang_available": True,
                "google_code": "ru",
            },
            "fr_FR": {
                "title": self.tr("French"),
                "lang_available": False,
                "google_code": "fr",
            },
            "es_ES": {
                "title": self.tr("Spanish"),
                "lang_available": True,
                "google_code": "es",
            },
            "af_ZA": {
                "title": self.tr("Afrikaans"),
                "lang_available": False,
                "google_code": "af",
            },
            "sq_AL": {
                "title": self.tr("Albanian"),
                "lang_available": False,
                "google_code": "sq",
            },
            "am_ET": {
                "title": self.tr("Amharic"),
                "lang_available": False,
                "google_code": "am",
            },
            "ar_SA": {
                "title": self.tr("Arabic"),
                "lang_available": False,
                "google_code": "ar",
            },
            "hy_AM": {
                "title": self.tr("Armenian"),
                "lang_available": False,
                "google_code": "hy",
            },
            "az_AZ": {
                "title": self.tr("Azerbaijani"),
                "lang_available": False,
                "google_code": "az",
            },
            "eu_ES": {
                "title": self.tr("Basque"),
                "lang_available": False,
                "google_code": "eu",
            },
            "bn_BD": {
                "title": self.tr("Bengali"),
                "lang_available": False,
                "google_code": "bn",
            },
            "bg_BG": {
                "title": self.tr("Bulgarian"),
                "lang_available": False,
                "google_code": "bg",
            },
            "ca_ES": {
                "title": self.tr("Catalan"),
                "lang_available": False,
                "google_code": "ca",
            },
            "hr_HR": {
                "title": self.tr("Croatian"),
                "lang_available": False,
                "google_code": "hr",
            },
            "cs_CZ": {
            ...
            "et_EE": {
                "title": self.tr("Estonian"),
                "lang_available": False,
                "google_code": "et",
            },
            "tl_PH": {
                "title": self.tr("Filipino"),
                "lang_available": False,
                "google_code": "tl",
            },
            "fi_FI": {
                "title": self.tr("Finnish"),
                "lang_available": False,
                "google_code": "fi",
            },
            "ka_GE": {
                "title": self.tr("Georgian"),
                "lang_available": False,
                "google_code": "ka",
            },
            "de_DE": {
                "title": self.tr("German"),
                "lang_available": True,
                "google_code": "de",
            },
            "el_GR": {
            ...
            "gu_IN": {
                "title": self.tr("Gujarati"),
                "lang_available": False,
                "google_code": "gu",
            },
            "he_IL": {
                "title": self.tr("Hebrew"),
                "lang_available": False,
                "google_code": "he",
            },
            "hi_IN": {
            ...
            "hu_HU": {
                "title": self.tr("Hungarian"),
                "lang_available": False,
                "google_code": "hu",
            },
            "is_IS": {
                "title": self.tr("Icelandic"),
                "lang_available": False,
                "google_code": "is",
            },
            "id_ID": {
                "title": self.tr("Indonesian"),
                "lang_available": False,
                "google_code": "id",
            },
            "ga_IE": {
            ...
            "it_IT": {
                "title": self.tr("Italian"),
                "lang_available": False,
                "google_code": "it",
            },
            "ja_JP": {
                "title": self.tr("Japanese"),
                "lang_available": False,
                "google_code": "ja",
            },
            "kn_IN": {
                "title": self.tr("Kannada"),
                "lang_available": False,
                "google_code": "kn",
            },
            "kk_KZ": {
                "title": self.tr("Kazakh"),
                "lang_available": False,
                "google_code": "kk",
            },
            "ko_KR": {
                "title": self.tr("Korean"),
                "lang_available": False,
                "google_code": "ko",
            },
            "lo_LA": {
            ...
            "lv_LV": {
                "title": self.tr("Latvian"),
                "lang_available": False,
                "google_code": "lv",
            },
            "lt_LT": {
                "title": self.tr("Lithuanian"),
                "lang_available": False,
                "google_code": "lt",
            },
            "mk_MK": {
                "title": self.tr("Macedonian"),
                "lang_available": False,
                "google_code": "mk",
            },
            "ms_MY": {
            ...
            "ml_IN": {
                "title": self.tr("Malayalam"),
                "lang_available": False,
                "google_code": "ml",
            },
            "mt_MT": {
                "title": self.tr("Maltese"),
                "lang_available": False,
                "google_code": "mt",
            },
            "mn_MN": {
                "title": self.tr("Mongolian"),
                "lang_available": False,
                "google_code": "mn",
            },
            "ne_NP": {
                "title": self.tr("Nepali"),
                "lang_available": False,
                "google_code": "ne",
            },
            "no_NO": {
                "title": self.tr("Norwegian"),
                "lang_available": False,
                "google_code": "no",
            },
            "fa_IR": {
                "title": self.tr("Persian"),
                "lang_available": False,
                "google_code": "fa",
            },
            "pl_PL": {
                "title": self.tr("Polish"),
                "lang_available": False,
                "google_code": "pl",
            },
            "pt_PT": {
                "title": self.tr("Portuguese"),
                "lang_available": True,
                "google_code": "pt",
            },
            "pa_IN": {
                "title": self.tr("Punjabi"),
                "lang_available": False,
                "google_code": "pa",
            },
            "ro_RO": {
                "title": self.tr("Romanian"),
                "lang_available": False,
                "google_code": "ro",
            },
            "sr_RS": {
                "title": self.tr("Serbian"),
                "lang_available": False,
                "google_code": "sr",
            },
            "sk_SK": {
                "title": self.tr("Slovak"),
                "lang_available": False,
                "google_code": "sk",
            },
            "sl_SI": {
                "title": self.tr("Slovenian"),
                "lang_available": False,
                "google_code": "sl",
            },
            "sw_KE": {
                "title": self.tr("Swahili"),
                "lang_available": False,
                "google_code": "sw",
            },
            "sv_SE": {
                "title": self.tr("Swedish"),
                "lang_available": False,
                "google_code": "sv",
            },
            "ta_IN": {
            ...
            "tr_TR": {
                "title": self.tr("Turkish"),
                "lang_available": False,
                "google_code": "tr",
            },
            "uk_UA": {
                "title": self.tr("Ukrainian"),
                "lang_available": True,
                "google_code": "uk",
            },
            "ur_PK": {
        ...
        self.settings_data = [
                ...
                "settings": [
                    {
                        "type": "pushbutton",
                        "label": (
                            self.tr("Character.AI Login")
                            + "\n"
                            + self.tr("Valid until: ")
                            + self.mw.settings.value("cai_auth/expiration_date")
                            if self.mw.settings.value("cai_auth/expiration_date")
                            else self.tr("Character.AI Login")
                        ),
                        "buttonlabel": (
                            self.tr("Re-Auth with Character.AI")
                            if self.mw.token
                            else self.tr("Auth with Character.AI")
                        ),
                        "key": "auth_cookie_get",
                        "click": self.getCookies,
                    },
                    {
                        "type": "pushbutton",
                        "label": self.tr("User Settings"),
                        "buttonlabel": self.tr("Open"),
                        "key": "cai_edit",
                        "click": self.openUserSettings,
                    },
                ],
            },
            {
                ...
                "settings": [
                    {
                        "type": "combobox",
                        "label": self.tr("App theme"),
                        "items": TM.get_themes_name(),
                        "key": "app_theme",
                    },
                    {
                        "type": "pushbutton",
                        "label": self.tr("Theme Catalog"),
                        "buttonlabel": self.tr("Open"),
                        "key": "app_theme_catalog",
                        "click": self.openThemeCatalog,
                    },
                    {
                        "type": "checkbox",
                        "label": self.tr("Sync theme with system theme"),
                    ...
                    {
                        "type": "combobox",
                        "label": self.tr("Input Device"),
                        "items": self.mw.input_devices.values(),
                        "key": "input_device",
                    },
                    {
                        "type": "combobox",
                        "label": self.tr("Output Device"),
                        "items": self.mw.output_devices.values(),
                        "key": "output_device",
                    },
                    {
                        "type": "keybind",
                        "label": self.tr("Microphone mute key"),
                        "def_value": "Ctrl+M",
                        "key": "microphone_mute_key_bind",
                    },
                    {
                        "type": "checkbox",
                        "label": self.tr("Use the old implementation of voice chat"),
                        "key": "use_old_voice_chat",
                    },
                ],
            },
            {
                ...
                "settings": [
                    {
                        "type": "checkbox",
                        "label": self.tr("Use VTube Studio"),
                        "key": "vtube/use",
                        "def_value": False,
                    },
                    {
                        "type": "lineedit",
                        "label": self.tr("VTube Studio Address"),
                        "key": "vtube/address",
                        "def_value": "127.0.0.1",
                        "may_be_empty": False,
                    },
                    {
                        "type": "lineedit",
                        "label": self.tr("VTube Studio Port"),
                        "key": "vtube/port",
                    ...
                    {
                        "type": "pushbutton",
                        "label": self.tr("VTube Emotes Editor"),
                        "buttonlabel": self.tr("Open"),
                        "key": "vtube/emotes_editor",
                        "click": self.openEmotesEditor,
                    },
                    {
                        "type": "pushbutton",
                        "label": self.tr("Check the connection to VTube Studio"),
                        "buttonlabel": self.tr("Check"),
                        "key": "vtube/check_connect",
                        "click": self.vtubeCheck,
                    },
                ],
            },
            {
                ...
                "settings": [
                    {
                        "type": "checkbox",
                        "label": self.tr("Use VModel"),
                        "key": "vmodel/use",
                        "def_value": False,
                    },
                    {
                        "type": "pushbutton",
                        "label": self.tr("Models folder"),
                        "buttonlabel": self.tr("Change"),
                        "key": "vmodel/change_default_folder",
                        "click": self.changeVModelFolder,
                    },
                    {
                        "type": "lineedit",
                        "label": self.tr("FPS"),
                    ...
                    {
                        "type": "checkbox",
                        "label": self.tr("Cursor Tracking"),
                        "key": "vmodel/cursor_tracking",
                        "def_value": True,
                    },
                    {
                        "type": "checkbox",
                        "label": self.tr("Auto Blink"),
                        "key": "vmodel/auto_blink",
                        "def_value": True,
                    },
                    {
                        "type": "lineedit",
                        "label": self.tr("Volume Smoothing"),
                        "key": "vmodel/volume_smoothing",
                        "def_value": "0.6",
                        "may_be_empty": False,
                    },
                ],
            },
            {
                ...
                "settings": [
                    {
                        "type": "checkbox",
                        "label": self.tr("Enable DiscordRPC"),
                        "key": "discord_rpc/enable",
                        "def_value": True,
                    },
                    {
                        "type": "checkbox",
                        "label": self.tr("Display the current page"),
                        "key": "discord_rpc/show_current_page",
                        "def_value": True,
                    },
                    {
                        "type": "checkbox",
                        "label": self.tr("Displaying the chat name"),
                        "key": "discord_rpc/show_chat_name",
                        "def_value": False,
                    },
                    {
                        "type": "checkbox",
                        "label": self.tr(
                            "Displaying the nickname of the profile being viewed"
                        ),
                        "key": "discord_rpc/show_username",
                        "def_value": False,
                    },
                ],
            },
            {
                ...
                "settings": [
                    {
                        "type": "combobox",
                        "label": self.tr("Emilia Language"),
                        "items": [
                            lang["title"]
                            for lang in self.languages.values()
                            if lang.get("lang_available", False)
                        ],
                        "key": "emilia_language",
                    },
                    {
                        "type": "checkbox",
                        "label": self.tr("Translate user's messages"),
                        "key": "tr_user_msg",
                    },
                    {
                        "type": "combobox",
                        "label": self.tr("Translate user's messages to"),
                        "items": [lang["title"] for lang in self.languages.values()],
                        "key": "tr_user_msg_to",
                    },
                    {
                        "type": "checkbox",
                        "label": self.tr("Translate character messages"),
                        "key": "tr_char_msg",
                    },
                    {
                        "type": "combobox",
                        "label": self.tr("Translate character messages to"),
                        "items": [lang["title"] for lang in self.languages.values()],
                        "key": "tr_char_msg_to",
                    },
                ],
            },
            {
                ...
                "settings": [
                    {
                        "type": "pushbutton",
                        "label": self.tr("Did you find a problem?"),
                        "buttonlabel": self.tr("Report a Problem"),
                        "key": "other/report_a_problem",
                        "click": lambda: webbrowser.open(
                            "https://github.com/Kajitsy/Emilia/issues"
                        ),
                    },
                    {
                        "type": "pushbutton",
                        "label": self.tr("Settings Folder"),
                        "buttonlabel": self.tr("Open"),
                        "key": "other/settings_folder",
                        "click": lambda: self.open_folder(
                            os.path.dirname(self.mw.settings.fileName())
                        ),
                    },
                    {
                        "type": "pushbutton",
                        "label": self.tr("Logs Folder"),
                        "buttonlabel": self.tr("Open"),
                        "key": "other/logs_folder",
                        "click": lambda: self.open_folder(
                            Path(user_log_dir("Emilia", False))
                        ),
                    },
                ],
            },
            {
                ...
                "settings": [
                    {
                        "label": self.tr(
                            "Emilia is a desktop version of Character.AI with several improvements and additional features."
                        )
                        + "\n"
                        + self.tr(
                            "The program is distributed free of charge under the MIT License."
                        ),
                        "key": "about/title",
                    },
                    {
                        "label": self.tr(
                            "By using Emilia, you accept the Terms of Use Character.AI and confirm that you have read the Privacy Policy Character.AI"
                        ),
                        "key": "about/tos",
                    },
                ],
        ...
        self.top_bar, self.top_bar_layout = self.createTopBar()
        self.scroll_area, self.settings_viewport, self.settings_layout = (
            self.createMainContentPage()
        )
    ...
    def changeVModelFolder(self):
        folder_path = QFileDialog.getExistingDirectory(
            self,
            "Select folder",
            self.mw.settings.value("vmodel/default_folder", "./vtubes"),
        )
        if os.path.exists(folder_path):
            ...
            self.mw.showNotification(
                self.tr("$mc models found").replace("$mc", str(models_count))
            )

    def openEmotesEditor(self):
        with open("./data/VTube_Emotes.json", "r") as f:
            emotes_data = json.load(f)

        def createEmoteSlot(
            emote, param_name="", random_value=False, value=0, value_1=0, value_2=100
        ):
            def updateRandom():
            ...
            def updateParamValue1(text):
                ...
                value_1 = text
                if random_value:
                    emotes_data[emote]["params"][
                        param_name
                    ] = f"rndm({value_1}, {value_2})"
            ...
            param_name_edit.textChanged.connect(
                lambda t: updateParamName(t, param_name)
            )
        ...
        for emote_name in emotes_data.keys():
            ...
            test_emote_button.clicked.connect(
                lambda _, e=emote_name: self.chat_thread.vtube_use_emote(e)
            )
            ...
            for param in list(params.keys()):
                ...
                if random_value:
                    param_widget = createEmoteSlot(
                        emote_name,
                        param,
                        random_value,
                        value_1=params[param].strip("rndm ()").split(", ")[0],
                        value_2=params[param].strip("rndm ()").split(", ")[1],
                    )
                else:
                    param_widget = createEmoteSlot(
                        emote_name, param, random_value, params[param]
                    )
                e_layout.addWidget(param_widget)
            add_button = PushButton(self.tr("Add parameter"))
            add_button.clicked.connect(
                lambda _, b=add_button, l=e_layout, e=emote_name: createParameter(
                    b, l, e
                )
            )
    ...
    def createMainContentPage(self):
        ...
        for setting_group in self.settings_data:
            ...
            if group_beta:
                group_label.setText(
                    f'{format_text(setting_group["label"])} {self.tr("(Beta)")}'
                )
            font = group_label.font()
            font.setBold(True)
            font.setPointSize(14)
            ...
            for setting in setting_group["settings"]:
                ...
                if setting.get("type"):
                    if setting["type"] == "lineedit":
                        ...
                        widget.setEchoMode(
                            setting.get("echo", LineEdit.EchoMode.Normal)
                        )
    ...
    def getCookies(self):
        ...
        def get(auth_token, expiration_date: QDateTime):
            ...
            self.mw.settings.setValue(
                "cai_auth/expiration_date", expiration_date.toString("yyyy.MM.dd HH:mm")
            )
    ...
    def showEvent(self, event):
        ...
        if self.mw.drpc_enable and self.mw.drpc_show_current_page:
            self.discord_thread.update(details=self.tr("Looking at the settings..."))

    def loadSettings(self):
        for key, widget in self.setting_widgets.items():
            if isdeleted(widget):
                continue
            value = self.mw.settings.value(
                key, str(self.setting_data[key].get("def_value"))
            )
            if isinstance(widget, LineEdit):
                widget.setText(value if value is not None else "")
            elif isinstance(widget, CheckBox):
                value = self.mw.settings.value(
                    key, self.setting_data[key].get("def_value"), type=bool
                )
                widget.setChecked(value)
            elif isinstance(widget, ComboBox):
                if key == "emilia_language":
                    widget.setCurrentText(
                        self.languages.get(self.mw.current_language, {}).get(
                            "title", self.tr("English")
                        )
                    )
        ...
        logging.debug(
            f"main.py ({self.__class__.__name__}.{inspect.currentframe().f_code.co_name}): Settings are loaded"
        )
    ...
    def saveSettings(self):
        ...
        for key, widget in self.setting_widgets.items():
            ...
            if isinstance(widget, LineEdit):
                if (
                    not self.setting_data.get(key).get("may_be_empty", True)
                    and not widget.text()
                ):
                    self.mw.showNotification(
                        self.setting_data[key]["label"] + self.tr(" cannot be empty")
                    )
                    return
                ...
                if self.mw.drpc_enable:
                    if self.mw.drpc_show_current_page:
                        self.discord_thread.update(
                            state=self.tr("Looking at the settings...")
                        )
                    else:
                        self.discord_thread.update()
            elif isinstance(widget, ComboBox):
                if key == "emilia_language":
                    lang = next(
                        (
                            ...
                            if v["title"] == widget.currentText()
                            and v.get("lang_available", False)
                        ),
                        None,
                    )
                    ...
                    if key == "input_device":
                        index = next(
                            k
                            for k, v in self.mw.input_devices.items()
                            if v == widget.currentText()
                        )
                    elif key == "output_device":
                        index = next(
                            k
                            for k, v in self.mw.output_devices.items()
                            if v == widget.currentText()
                        )
        ...
        logging.debug(
            f"main.py ({self.__class__.__name__}.{inspect.currentframe().f_code.co_name}): Settings saved successfully"
        )
