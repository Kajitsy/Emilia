...
class MainCharCreatePage(QWidget):
    ...
    def initUI(self):
        ...
        scroll_layout.addWidget(
            self.char_scene_label, alignment=Qt.AlignmentFlag.AlignLeft
        )
        ...
        self.when_scene_label.setToolTip(
            self.tr(
                "Set the time. This guides the Character contextually when the Scenes is taking place."
            )
        )
        scroll_layout.addWidget(
        ...
        self.where_scene_label.setToolTip(
            self.tr(
                "Set the location. This grounds the Character where the Scenes is taking place."
            )
        )
        scroll_layout.addWidget(
        ...
        self.tone_scene_label.setToolTip(
            self.tr(
                "What's the mood of the Scenes? The defines the atmosphere and emotional tone to help your audience immerse."
            )
        )
        scroll_layout.addWidget(
        ...
        self.tone_scene_edit.setPlaceholderText(
            self.tr(
                "What’s the mood of the Scenes? This defines the atmosphere and emotional tone to help your audience immerse."
            )
        )
        ...
        self.what_scene_label.setToolTip(
            self.tr(
                "Describe what is happening in this Scenes. Include relevant details about the situation and backstory. This will help shape how the Scenes unfolds and how the Character responds. Use {{user}} for the user. Use {{char}} for the Character. If you are building an Any-Character Scenes we recommend that you avoid the following pronouns: he, she, his, her, so your Scenes can work for any character."
            )
        )
        scroll_layout.addWidget(
        ...
        self.what_scene_edit.setPlaceholderText(
            self.tr(
                """Describe what is happening in this Scenes. Include relevant details about the situation and backstory. This will help shape how the Scenes unfolds and how the Character responds.
...
"""
        ...
        self.goal_scene_label = QLabel(
            self.tr("What's the player's goal in this Scenes?")
        )
...
"""
        ...
        self.audience_scene_label = QLabel(
            self.tr("Introduce this Scenes to your audience")
        )
        self.audience_scene_label.setFont(font)
        self.audience_scene_label.setToolTip(
            self.tr(
                "This is the starting screen of your Scenes. Your audience will see this intro before entering the Scenes. Help them understand what’s happening and get excited to start playing the Scenes. Use {{user}} for the user. Use {{char}} for the Character."
            )
        )
        scroll_layout.addWidget(
        ...
        self.greeting_edit.setPlaceholderText(
            self.tr(
                "This is the first Character message your audience will see after entering the Scenes. Make it your hook with what they will see, hear, and feel."
            )
        )
        ...
        self.name_scene_edit.setPlaceholderText(
            self.tr('Give your Scenes a memorable name. e.g. "Her Last Secret"')
        )
    ...
    def saveSceneChat(self):
        if (
            ...
            or not self.current_character_id
        ):
    ...
    def selectCharacter(self, mouseclick=None):
        ...
        recent_button.clicked.connect(
            lambda: pages_widget.setCurrentWidget(recent_page)
        )
