...
from PyQt6.QtWidgets import QHBoxLayout, QVBoxLayout, QLabel, QSizePolicy, QWidget, QFileDialog
from curl_cffi import CurlMime

from modules.ui.Elements import CustomTextEdit, PushButton, LineEdit, ComboBox, VerticalScrollPage
...
class AnyCharCreatePage(QWidget):
    ...
    def initUI(self):
        ...
        self.when_scene_label.setToolTip(
            self.tr("Set the time. This guides the Character contextually when the Scene is taking place."))
        ...
        self.where_scene_label.setToolTip(
            self.tr("Set the location. This grounds the Character where the Scene is taking place."))
        ...
        self.tone_scene_label.setToolTip(self.tr(
        ...
        self.tone_scene_edit.setPlaceholderText(self.tr(
        ...
        self.what_scene_label.setToolTip(self.tr(
...
"""))
        ...
        self.goal_scene_label.setToolTip(self.tr(
...
"""))
        ...
        self.audience_scene_label.setToolTip(self.tr(
        ...
        self.audience_scene_edit.setPlaceholderText(self.tr(
            "This is the starting screen of your Scene. Your audience will see this intro before entering the Scene. Help them understand what’s happening and get excited to start playing the Scene. Use {{user}} for the user. Use {{char}} for the Character."))
        ...
        self.greeting_edit.setPlaceholderText(self.tr(
    ...
    def saveSceneChat(self):
        if len(self.scene_genre_edit.text()) <= 1 or len(self.when_scene_edit.text()) <= 1 or len(
                ...
                self.name_scene_edit.text()) <= 1 or not self.image_selected:
